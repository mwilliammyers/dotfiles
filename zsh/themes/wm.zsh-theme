...
PROMPT='%{$FG[136]%}%n%{$reset_color%}@%{$FG[061]%}%M%{$reset_color%}: %{$FG[033]%}%~%b%{$reset_color%} $(git_time_since_commit)$(check_git_prompt_info)
$ '
...
#print -P -- "--------   ------- ---- -------  ----------- ---------- ----------- -----------"
#print -P -- "#%F{F234}base03    #002b36  8/4 brblack  234 #1c1c1c 15 -12 -12   0  43  54 193 100  21%f"
